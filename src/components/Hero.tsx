...
//       style={{
//         backgroundImage: "url('/public/moni 2.png')",
//       }}
//     >
//       {/* CONTENT */}
//       <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
//         <div className="max-w-xl justify-center">
//           <h1 className="text-4xl text-left md:text-5xl font-bold text-gray-700 leading-snug">
//             İxtisaslaşmış Tibbi <br />
//             Xidmətin Tək Ünvanı!
//           </h1>

//           <button className="mt-10 inline-flex items-center gap-2 bg-sky-500 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-sky-600 transition">
//             Bütün xidmətlər
//           <img src={arrow}/>
//           </button>
//         </div>
